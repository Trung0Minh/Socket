...
const std::string TokenManager::TOKEN_FILE = "YOUR TOKEN FILE";
const std::string TokenManager::CLIENT_ID = "YOUR CLIENT ID";
const std::string TokenManager::CLIENT_SECRET = "YOUR CLIENT SECRET";
...
bool TokenManager::loadTokenFile() {
    try {
        ...
        if (!file.is_open()) {
            std::cerr << "Cannot open file: " << TOKEN_FILE << std::endl;
            return false;
        }
